...
const Signup = () => {
  ...
  const validateForm = () => {
    ...
    if (formData.password.trim().length < 8)
      return toast.error("Password length must be atleast 8 characters");
    if (
      !formData.confirmPassword.trim() ||
      formData.confirmPassword.trim() !== formData.confirmPassword.trim()
    )
          ...
          <div className="form-control">
            ...
            <div className="relative">
              <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                <User2 className="size-5 z-10 text-base-content/40" />
              </div>
              <input
                type="text"
